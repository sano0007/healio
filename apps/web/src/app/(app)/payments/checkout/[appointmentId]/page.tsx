    ...
    <div className="max-w-7xl mx-auto py-8 lg:py-12 px-4 space-y-12">
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2 text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] px-2 opacity-70">
           ...
           <Link href="/appointments" className="hover:text-brand-dark transition-colors">Appointments</Link>
           <ChevronRight className="w-3 h-3" />
           <span className="text-brand-dark font-black underline underline-offset-4">Checkout</span>
        </div>
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 px-2">
           ...
           <div className="flex items-center gap-3 bg-emerald-50/50 p-4 rounded-2xl border border-emerald-100 shadow-sm">
              ...
              <div className="flex flex-col">
                 <span className="text-[10px] font-black text-emerald-800 uppercase tracking-widest leading-none mb-0.5">Payment Security</span>
                 <span className="text-[9px] font-bold text-emerald-600 opacity-80">PCI-DSS Compliant Infrastructure</span>
              </div>
           </div>
        </div>
      </div>
           ...
           >
              ...
              >
                 ...
                 <p className="text-[10px] font-black text-brand-dark uppercase tracking-widest flex items-center gap-2">
                    <span className="opacity-50 italic">Redirecting to Dashboard</span>
                    <SpinnerDark />
                 </p>

                 <Link href="/appointments">
                    <Button variant="outline" className="h-10 rounded-xl px-6 text-[10px] font-black uppercase tracking-widest gap-2">
                       Dismiss
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16">
        ...
        <div className="lg:col-span-2 order-2 lg:order-1 pt-6 lg:pt-0">
           <div className="px-2 pb-10 border-b border-gray-50 flex items-center gap-3">
              <span className="w-8 h-8 rounded-full bg-brand-dark text-white text-[10px] font-black flex items-center justify-center shadow-lg shadow-brand-dark/20">01</span>
              <p className="text-[11px] font-black text-brand-black uppercase tracking-widest">Select Payment Method</p>
           </div>
           ...
           <div className="p-8 rounded-[2.5rem] bg-gray-50 border border-gray-100 flex items-start gap-4">
              ...
              <div className="space-y-1">
                 <span className="text-[10px] font-black text-brand-black uppercase tracking-widest">Guaranteed Data Privacy</span>
                 <p className="text-[10px] font-medium text-gray-400 italic leading-relaxed">
                    By clicking authorize, you agree to our Terms of Service. Your data is encrypted and signature-signed for HIPAA-grade security.
                 </p>
              </div>
           </div>
        </div>
