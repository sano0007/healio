    ...
    <div className="max-w-7xl mx-auto px-6 py-10" onClick={handleInteraction}>
      ...
      <div className="mt-20 pt-12 border-t border-gray-100 flex flex-col md:flex-row items-center justify-between gap-6 opacity-60 hover:opacity-100 transition-opacity">
        <div className="flex items-center gap-6">
          <p className="text-[10px] font-black text-brand-black uppercase tracking-[0.2em] border-r border-gray-200 pr-6">
            Healio Security Shield v4.2
          </p>
          <p className="text-[10px] font-medium text-gray-400 italic">
            HIPAA Compliant • AES-256 Encrypted • GDPR Ready
          </p>
        </div>
        <div className="flex items-center gap-4">
          <button className="text-[10px] font-bold text-gray-400 uppercase tracking-widest hover:text-brand-dark transition-colors">
            Privacy Policy
          </button>
