...
export default function IssuePrescriptionPage({params}: { params: Promise<{ appointmentId: string }> }) {
    ...
    return (
        <div className="max-w-4xl mx-auto px-6 py-10 space-y-10">
            ...
            <div className="space-y-2">
                <h1 className="text-4xl font-bold text-brand-black tracking-tight">Issue Prescription</h1>
                <p className="text-sm text-gray-400 font-medium">Create a digital prescription for your patient</p>
            </div>
            ...
            {appointment && (
                ...
                >
                    <div
                        className="w-16 h-16 rounded-2xl bg-gray-50 flex items-center justify-center text-gray-300 border border-gray-100">
                        <User className="w-7 h-7"/>
                    </div>
                    <div>
                        <h3 className="text-lg font-bold text-brand-black">Patient</h3>
                        <p className="text-[10px] font-medium text-gray-400 uppercase tracking-widest">ID: {appointment.patientId.slice(0, 8)}</p>
                        {appointment.notes && (
                            <p className="text-xs text-gray-400 italic mt-1">"{appointment.notes}"</p>
                        )}
                    </div>
                    <div className="ml-auto text-right">
                        <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">Scheduled</p>
            ...
            <div className="bg-white rounded-[2.5rem] border border-gray-100 p-8 shadow-sm space-y-6">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <div
                            className="w-8 h-8 rounded-xl bg-brand-dark text-white flex items-center justify-center text-sm font-black">Rx
                        </div>
                    ...
                    {medications.map((med, index) => (
                        ...
                        >
                            <div className="col-span-12 sm:col-span-3">
                                <label
                                    className="text-[9px] font-black text-gray-400 uppercase tracking-widest mb-2 block">Medication
                                    Name</label>
                                <input
                                    type="text"
                                    value={med.name}
                            ...
                            <div className="col-span-4 sm:col-span-2">
                                <label
                                    className="text-[9px] font-black text-gray-400 uppercase tracking-widest mb-2 block">Dosage</label>
                                <input
                                    type="text"
                                    value={med.dosage}
                            ...
                            <div className="col-span-4 sm:col-span-3">
                                <label
                                    className="text-[9px] font-black text-gray-400 uppercase tracking-widest mb-2 block">Frequency</label>
                                <input
                                    type="text"
                                    value={med.frequency}
                            ...
                            <div className="col-span-4 sm:col-span-3">
                                <label
                                    className="text-[9px] font-black text-gray-400 uppercase tracking-widest mb-2 block">Duration</label>
                                <input
                                    type="text"
                                    value={med.duration}
            ...
            {/* Notes */}
            <div className="bg-white rounded-[2.5rem] border border-gray-100 p-8 shadow-sm space-y-4">
                <h2 className="text-lg font-bold text-brand-black">Clinical Notes (Optional)</h2>
                <textarea
                    value={notes}
