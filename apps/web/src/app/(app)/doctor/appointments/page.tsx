          ...
          {filtered.map((apt, i) => (
            ...
            >
              <div className="flex flex-col lg:flex-row lg:items-center gap-8">
                ...
                {/* Notes */}
                {apt.notes && (
                  <p className="text-xs text-gray-400 italic lg:max-w-xs">
                    "{apt.notes}"
                  </p>
                )}
                  ...
                  {apt.status === 'pending' && (
                    <>
                      ...
                      <Button
                        ...
                        onClick={() => {
                          setAcceptError(null);
                          acceptMutation.mutate(apt._id, {
                            onError: (e: any) =>
                              setAcceptError(e?.message || 'Failed to accept'),
                          });
                        }}
