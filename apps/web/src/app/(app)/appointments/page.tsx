      ...
      <div className="mt-20 p-8 bg-brand-light/5 rounded-[2.5rem] border border-brand-light/10 flex flex-col md:flex-row gap-8 items-center text-center md:text-left transition-all hover:bg-brand-light/10">
        ...
        <div className="flex-1 space-y-2">
          ...
          <p className="text-sm text-gray-500 font-medium">
            Browse our expert doctors by specialty, rating, or availability and
        ...
        <Link href="/doctors">
          <Button
            variant="dark"
            className="h-14 px-10 rounded-2xl text-sm font-bold gap-2 shadow-xl shadow-brand-dark/10 group"
          >
            Find a Specialist
