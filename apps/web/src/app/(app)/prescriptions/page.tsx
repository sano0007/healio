    ...
    <div className="max-w-7xl mx-auto py-8 lg:py-12 px-4 space-y-12 mb-20">
      ...
      <section className="space-y-6">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-xl font-bold text-brand-black tracking-tight uppercase tracking-widest text-[11px] leading-none">
      ...
      <section className="space-y-8">
        <div className="flex items-center justify-between">
          ...
          <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest hover:text-brand-dark cursor-pointer transition-colors">
            See all active medications
          </p>
        </div>
          ...
          <AnimatePresence>
            {isLoading
              ? Array.from({ length: 3 }).map((_, i) => (
                  <div
                    key={i}
                    className="h-80 bg-gray-50 rounded-[2.5rem] p-8 space-y-6 animate-pulse border border-gray-100"
                  >
      ...
      <div className="p-10 bg-brand-black rounded-[3rem] text-white flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden shadow-2xl">
        <div className="relative z-10 space-y-3">
          <h3 className="text-2xl font-bold tracking-tight">
            Personalized Health Compliance
          </h3>
          <p className="text-sm text-white/50 max-w-xl font-medium leading-relaxed">
            Tracking your medication compliance helps doctors adjust your
            treatment plan more accurately. Keep your routine updated for better
            clinical outcomes.
          </p>
        </div>
        <Button
          variant="outline"
          className="relative z-10 h-14 rounded-2xl px-10 text-[10px] font-black uppercase tracking-widest border-white/10 hover:bg-white/10 text-white shadow-xl"
        >
          View Analytics Hub
        </Button>
