        ...
        <AnimatePresence mode="popLayout">
          {isLoading ? (
            Array.from({ length: 8 }).map((_, i) => (
              <div
                key={i}
                className="h-64 bg-gray-50 rounded-[2.5rem] p-6 space-y-4 animate-pulse"
              >
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 font-medium">
                  Try adjusting your filters or upload your first medical
                  record.
                </p>
              </div>
            </motion.div>
      ...
      {!isLoading && (
        <div className="pt-10 flex flex-col md:flex-row items-center justify-between border-t border-gray-50 gap-6">
          <p className="text-sm text-gray-400 font-medium text-center md:text-left">
            Can't find a record? Contact your{' '}
