...
export function BookingWidget({
  ...
  const handleBook = () => {
    ...
    router.push(
      `/appointments/book/${doctorId}?date=${dateStr}&time=${encodeURIComponent(selectedTime)}`,
    );
  };
    ...
    <div className="bg-white rounded-[2.5rem] p-8 border border-gray-100 shadow-xl shadow-brand-dark/5 sticky top-24 self-start">
      ...
      <div className="flex p-1.5 bg-gray-50 rounded-2xl mb-8 border border-gray-100">
        <button
          ...
          className={cn(
            ...
            type === 'video'
              ? 'bg-white shadow-sm text-brand-dark border border-brand-light/10'
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-4 px-1">
          ...
          <span className="text-[11px] font-bold text-brand-dark hover:underline cursor-pointer uppercase tracking-tight">
            July 2026
          </span>
        </div>
