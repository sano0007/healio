...
export function DoctorStatsGrid({
  ...
  const stats = [
    { label: "Patients", value: patients, icon: Users, color: "text-blue-600", bg: "bg-blue-50" },
    { label: "Experience", value: `${experience}+ Yrs`, icon: GraduationCap, color: "text-emerald-600", bg: "bg-emerald-50" },
    { label: "Rating", value: rating, icon: Star, color: "text-amber-600", bg: "bg-amber-50" },
    { label: "Reviews", value: reviews, icon: MessageSquare, color: "text-purple-600", bg: "bg-purple-50" },
  ];
