      ...
      <div className="lg:col-span-1 space-y-8">
        <div className="p-10 bg-brand-light/5 rounded-[3rem] border border-brand-light/10 text-center space-y-6 relative overflow-hidden group">
          ...
          <div className="space-y-1">
            ...
            <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest italic leading-none underline decoration-brand-light underline-offset-4 decoration-2">
              Patient Member
            </p>
          </div>

          <p className="text-xs text-gray-400 font-medium leading-relaxed px-4">
            Upload a professional photo for better identification within our
            clinical network.
          </p>
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <div className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-brand-dark opacity-40 flex items-center">
        ...
        <div className="p-8 bg-brand-light/5 rounded-[2.5rem] border border-dashed border-brand-light/30 flex items-center justify-between">
          <div className="space-y-1">
            ...
            <p className="text-[10px] font-medium text-gray-500 italic">
              Your documents are securely encrypted and only visible to
