    ...
    <div className="mb-12 flex flex-col md:flex-row justify-between md:items-end gap-8">
      <div className="space-y-4">
        ...
        <div className="space-y-1">
          <h1 className="text-4xl font-bold text-brand-black tracking-tight">Profile & Preferences</h1>
          <p className="text-sm text-gray-400 font-medium italic">Manage your digital identity, security protocols, and clinical metadata.</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-10">
        ...
        <div className="text-right space-y-1">
          <span className="text-[10px] font-black text-brand-black uppercase tracking-[0.2em] block pr-1">Completion</span>
