        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start mt-2">
          ...
          <div>
            <h2 className="text-2xl sm:text-3xl lg:text-[2rem] font-bold text-brand-black leading-snug mb-10">
              Our dedicated medical team highly experienced doctors and
              specialists committed to your unique health journey. Experience
              healthcare made effortless with our patient first approach.
            </h2>

            <div className="mt-10">
              <p className="text-sm font-semibold text-brand-black mb-3">
                Join the Healio Community
              </p>
          ...
          <div className="grid grid-cols-5 grid-rows-2 gap-3.5">
            ...
            <div className="col-span-3 rounded-2xl bg-brand-lightest p-6 flex flex-col justify-between min-h-[160px]">
              <span className="text-5xl sm:text-6xl font-bold text-brand-dark tracking-tight leading-none">
                5k+
              </span>
            ...
            <div className="col-span-3 rounded-2xl bg-brand-dark p-6 flex flex-col justify-between min-h-[140px]">
              <span className="text-5xl sm:text-6xl font-bold text-white tracking-tight leading-none">
                100%
              </span>
