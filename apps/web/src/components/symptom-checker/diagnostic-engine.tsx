    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[500px] space-y-8 py-20">
        ...
        <Button
          onClick={onReset}
          variant="outline"
          className="h-12 rounded-2xl px-8 text-xs font-black uppercase tracking-widest border-gray-200 flex items-center gap-2"
        >
      ...
      <div className="w-full max-w-md space-y-8 text-center px-6">
        <div className="space-y-3">
          ...
          <p className="text-sm font-medium text-gray-400 italic">
            Processing natural language inputs with Healio AI...
          </p>
        </div>
        ...
        <div className="space-y-6">
          <div className="w-full h-2.5 bg-gray-50 rounded-full border border-gray-100 overflow-hidden relative shadow-inner">
            <motion.div
              initial={{ width: '0%' }}
              animate={{
                width: `${((currentStep + 1) / diagnosticSteps.length) * 100}%`,
              }}
