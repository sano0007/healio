...
export function TriageResults({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          'p-8 rounded-[3rem] border flex items-center justify-between gap-8 relative overflow-hidden',
          getSeverityStyle(results.severity),
        )}
      >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="flex items-center justify-between px-4">
            ...
            <p className="text-[10px] font-bold text-brand-dark italic">
              Confidence Rank
            </p>
          </div>
            ...
            {results.conditions.map((condition, i) => (
              ...
              >
                ...
                <div className="flex items-center justify-between pt-6 border-t border-gray-50">
                  ...
                  <Link
                    href={`/doctors?specialty=${condition.specialist}`}
                    className="text-[10px] font-black text-brand-dark uppercase tracking-widest flex items-center gap-1.5 hover:gap-3 transition-all"
                  >
                    Find Specialists
