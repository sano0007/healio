...
const mockHistory = [
  ...
  { id: "RX-1018", name: "Lisinopril 10mg", doctor: "Dr. Michael Chen", date: "June 28, 2026", status: "Active", pharmacy: "Walgreen's Healthcare" },
  { id: "RX-0982", name: "Ibuprofen 400mg", doctor: "Dr. Emily Davis", date: "May 15, 2026", status: "Expired", pharmacy: "City Medical Center" },
  { id: "RX-0842", name: "Metformin 500mg", doctor: "Dr. Sarah Johnson", date: "April 10, 2026", status: "Active", pharmacy: "CVS Pharmacy #402" },
  { id: "RX-0711", name: "Vitamin D3 1000IU", doctor: "Dr. Sarah Johnson", date: "March 22, 2026", status: "Active", pharmacy: "CVS Pharmacy #402" },
];
            ...
            {mockHistory.map((item, i) => (
              ...
              >
                <td className="py-5 pl-8 rounded-l-[2rem]">
                  <span className="text-[10px] font-black text-brand-dark px-2 py-1 bg-brand-light/10 rounded-lg border border-brand-light/20">{item.id}</span>
                </td>
                <td className="py-5">
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-xl bg-gray-50 flex items-center justify-center text-brand-dark group-hover:bg-white border border-gray-100 transition-colors">
                ...
                <td className="py-5">
                  ...
                  <span className="text-[9px] font-medium text-blue-500 uppercase tracking-widest flex items-center gap-1 group-hover:underline cursor-pointer">
