...
export function PrescriptionHistory({
        ...
        <div className="flex items-center justify-between pb-4 border-b border-gray-100">
          <div className="space-y-1">
            ...
            <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest italic">
              Viewing records for the last 12 months
            </p>
          </div>
        </div>
  ...
  const rows = prescriptions.map((rx) => ({
    ...
    date: new Date(rx.issuedAt).toLocaleDateString('en-US', {
      month: 'long',
      day: 'numeric',
      year: 'numeric',
    }),
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between pb-4 border-b border-gray-100">
        ...
        <Button
          variant="outline"
          className="h-10 rounded-2xl px-4 text-[10px] font-bold gap-2 border-gray-100 bg-white"
        >
              ...
              {rows.map((item, i) => (
                ...
                >
                  <td className="py-5 pl-8 rounded-l-[2rem]">
                    <span className="text-[10px] font-black text-brand-dark px-2 py-1 bg-brand-light/10 rounded-lg border border-brand-light/20">
                      {item.id}
                    </span>
                  </td>
                  <td className="py-5">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        {item.diagnosis && (
                          <p className="text-[9px] font-medium text-gray-400 italic line-clamp-1">
                            Dx: {item.diagnosis}
                          </p>
                        )}
                  ...
                  <td className="py-5">
                    <p className="text-[10px] font-bold text-gray-500 leading-none mb-1 uppercase tracking-tight">
                      {item.pharmacy}
                    </p>
