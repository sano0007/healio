    ...
    <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 pb-10 border-b border-gray-100">
        ...
        <div className="flex items-center gap-6">
          <p className="text-xs text-gray-400 font-medium italic">
            ...
            <span className="text-brand-dark font-black">
              {prescriptionCount} Active
            </span>{' '}
            medication{prescriptionCount !== 1 ? 's' : ''}.
          </p>
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="hidden lg:flex items-center gap-8 pr-10 border-r border-gray-100">
          <PrescriptionStat
            icon={<Activity className="text-brand-dark" />}
        ...
        <div className="flex items-center gap-3">
          <Button
            variant="outline"
            className="rounded-2xl h-12 px-6 text-xs font-bold gap-2 border-gray-100 hover:bg-gray-50"
          >
