    ...
    >
        ...
        <div className="flex flex-col items-end gap-2">
          ...
          {isRefillLow && (
            <div className="flex items-center gap-1.5 px-2 py-0.5 bg-rose-50 rounded-lg border border-rose-100 animate-pulse">
              ...
              <span className="text-[8px] font-bold text-rose-600 uppercase tracking-widest">
                Refill Soon
              </span>
            </div>
          )}
      ...
      <div className="flex-1 space-y-5">
        <div className="space-y-1">
          <h3 className="text-lg font-bold text-brand-black tracking-tight group-hover:text-brand-dark transition-colors">
            {name}
          </h3>
        ...
        <div className="p-4 bg-gray-50 rounded-3xl space-y-4 border border-gray-100/50">
          <div className="flex items-center justify-between">
            <div className="space-y-1">
              ...
              <p className="text-sm font-black text-brand-black tracking-widest uppercase">
                {frequency}
              </p>
            </div>
      ...
      <div className="pt-6 flex items-center justify-between gap-3">
        <Button
          variant="ghost"
          className="h-10 rounded-2xl px-4 text-[10px] font-bold gap-2 text-gray-400 hover:text-brand-dark hover:bg-brand-light/10"
        >
        ...
        <Button
          variant="dark"
          className="h-12 flex-1 rounded-2xl text-[10px] font-bold gap-2 shadow-lg shadow-brand-dark/10 group/btn"
        >
          Mark as Taken
