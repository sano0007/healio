  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      sender: 'doctor',
      text: 'Hello John, can you hear me clearly?',
      time: '09:30 AM',
    },
    {
      id: '2',
      sender: 'patient',
      text: 'Yes doctor, the connection is stable.',
      time: '09:31 AM',
    },
  ]);
        ...
        >
              ...
              <div className="space-y-6">
                {messages.map((msg) => (
                  ...
                  >
                    ...
                    <span className="text-[9px] font-bold text-white/30 uppercase tracking-widest mt-1.5 px-1">
                      {msg.time}
                    </span>
                  </div>
                ))}
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-6 bg-white/5 rounded-3xl border border-white/10 space-y-4">
                    <p className="text-xs text-brand-light/80 font-medium leading-relaxed italic">
                      "Patient describes intermittent chest pain over the last 3
                      days. Pain is localized behind the sternum..."
                    </p>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-xs font-bold text-white/70">
                          Heart rate within normal range (72 bpm)
                        </span>
                      </div>
                      <div className="flex items-center gap-3">
                        <div className="w-5 h-5 rounded-full bg-emerald-500/20 flex items-center justify-center text-emerald-500 border border-emerald-500/20">
                        ...
                        <span className="text-xs font-bold text-white/70">
                          Previous blood test reports reviewed
                        </span>
                      </div>
                    </div>
                  </div>
          ...
          {activeTab === 'chat' && (
            <div className="p-6 border-t border-white/5">
              ...
              <p className="text-[9px] font-bold text-white/20 uppercase tracking-widest mt-4 text-center">
                Consultation End-to-End Encrypted
              </p>
            </div>
          )}
        </motion.div>
