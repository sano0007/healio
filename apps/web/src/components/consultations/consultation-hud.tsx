...
export function ConsultationHUD({ doctorName, doctorSpecialty, doctorImage }: ConsultationHUDProps) {
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-4 pointer-events-auto">
          <div className="flex items-center gap-3 px-4 py-2 bg-brand-black/40 backdrop-blur-3xl rounded-2xl border border-white/10">
            <Avatar src={doctorImage} className="w-10 h-10 border-2 border-emerald-500/30" />
            <div>
              <p className="text-[12px] font-bold text-white leading-none mb-1">{doctorName}</p>
              <p className="text-[9px] font-bold text-white/50 uppercase tracking-widest">{doctorSpecialty}</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center pointer-events-auto">
          <div className="px-6 py-2 bg-brand-black/40 backdrop-blur-xl rounded-full border border-white/10 flex items-center gap-3">
            ...
            <span className="text-sm font-bold text-white font-mono tracking-wider">{formatTime(seconds)}</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4 pointer-events-auto">
          <div className="flex items-center gap-4 px-4 py-2 bg-brand-black/40 backdrop-blur-xl rounded-2xl border border-white/10">
            <div className="flex flex-col items-end">
              <p className="text-[9px] font-bold text-white/40 uppercase tracking-widest">Signal Quality</p>
