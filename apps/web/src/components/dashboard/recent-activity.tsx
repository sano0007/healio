  ...
  return (
    <div className="bg-white rounded-[2rem] p-8 border border-gray-100 shadow-sm">
      <div className="flex items-center justify-between mb-8">
        ...
        <Link href="/notifications" className="text-sm font-semibold text-brand-dark hover:underline flex items-center gap-1 group">
          ...
          >
            ...
            <div className="flex-1 pb-6 border-b border-gray-100 group-last:border-none">
              <div className="flex items-start justify-between mb-1">
                ...
                <span className="text-[10px] font-medium text-gray-400 uppercase tracking-wider">{activity.time}</span>
              </div>
