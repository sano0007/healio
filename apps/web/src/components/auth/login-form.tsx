    ...
    <div className="w-full animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="mb-10 text-center md:text-left">
        ...
        <p className="text-sm text-gray-500 leading-relaxed font-light">
          Enter your email and password to access your health journey account
        </p>
      </div>
      ...
      <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
        ...
        <div className="relative my-8">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-white px-4 text-gray-400 font-medium tracking-wider">or join with</span>
          </div>
        </div>

        <Button variant="outline" size="lg" className="w-full rounded-xl h-12 border-gray-200 hover:bg-gray-50 bg-white">
      ...
      <div className="mt-10 text-center">
        <p className="text-sm text-gray-500">
          ...
          <Link href="/auth/register" className="font-bold text-brand-dark hover:underline">
            Sign Up
          </Link>
        </p>
      </div>
