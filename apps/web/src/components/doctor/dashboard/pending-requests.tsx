...
} from '@/hooks/use-doctor-appointments';
    ...
    <div className="bg-white rounded-[3rem] border border-gray-100 p-8 shadow-sm space-y-8 h-full flex flex-col">
      ...
      <div className="flex-1 space-y-4 overflow-y-auto pr-2 custom-scrollbar">
        {pending.map((request) => {
          ...
          const patientName =
            patient?.name || `Patient ${request.patientId.slice(0, 6)}`;
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest">
                        ID: {request.patientId.slice(0, 8)}
                      </p>
                    </div>
                  </div>
                </div>
        ...
        {pending.length === 0 && (
          <div className="flex-1 flex flex-col items-center justify-center text-center space-y-4 opacity-40 py-20">
            ...
            <div>
              ...
              <p className="text-[11px] font-medium text-gray-500 italic max-w-[140px]">
      ...
      <div className="pt-6 border-t border-gray-100 text-center">
        <button
          ...
          className="text-[9px] font-black text-gray-400 uppercase tracking-widest hover:text-brand-dark transition-colors flex items-center justify-center gap-2 w-full active:scale-[0.98]"
        >
