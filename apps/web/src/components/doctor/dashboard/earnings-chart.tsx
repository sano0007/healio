  ...
  return (
    <div className="bg-white rounded-[3rem] border border-gray-100 p-10 shadow-sm flex flex-col h-full space-y-8">
              ...
              <div className="relative w-full flex flex-col justify-end h-[160px]">
                ...
                <motion.div
                  ...
                  className={cn(
                    ...
                    d.day === 'Thu'
                      ? 'bg-brand-dark shadow-xl shadow-brand-dark/20'
                      : 'bg-gray-100 group-hover:bg-brand-light',
                  )}
                >
      ...
      <div className="pt-6 border-t border-gray-100 flex items-center justify-between">
        ...
        <Button
          variant="outline"
          className="h-10 rounded-xl text-[9px] font-black uppercase tracking-widest border-gray-100 gap-2"
        >
          Details
