...
const defaultContent = {
  ...
  description:
    "You don't have any scheduled consultations. Need medical advice? Browse our top-rated specialists.",
  ...
  const content: typeof defaultContent =
    {
      ...
      completed: {
        ...
        description:
          'Your past appointment history will appear here once you finish a consultation.',
      ...
      canceled: {
        ...
        description:
          'Any canceled or rescheduled appointments will be tracked here for your reference.',
  ...
  return (
    ...
    >
      ...
      <Link href={content.link}>
        <Button
          variant="dark"
          className="h-14 px-10 rounded-2xl text-sm font-bold gap-3 shadow-xl shadow-brand-dark/10 hover:scale-[1.02] active:scale-95 transition-all"
        >
          {content.action}
