  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <Link href="/appointments" className="group flex items-center gap-2 text-sm font-bold text-gray-400 hover:text-brand-dark transition-colors">
        ...
        <div className="flex items-center gap-3">
          <Button variant="outline" size="icon" className="rounded-xl border-gray-100/50 hover:bg-gray-50">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm">
        <div className="space-y-2">
          <div className="flex items-center gap-3">
            <h1 className="text-2xl font-bold text-brand-black">Appointment Detail</h1>
            <div className={cn("px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest border", config.color)}>
              {config.label}
            </div>
          </div>
          <p className="text-sm text-gray-400 font-medium flex items-center gap-2">
            ID: <span className="text-brand-dark font-bold select-all">{appointmentId}</span>
        ...
        <div className="flex flex-wrap items-center gap-3">
          {status === "confirmed" && (
            <>
              <Button variant="outline" className="rounded-xl h-12 px-6 text-xs font-bold gap-2 border-brand-light/20 hover:bg-brand-light/5">
                <Calendar className="w-4 h-4" />
                Reschedule
              </Button>
              {type === "video" ? (
                <Button variant="dark" className="rounded-xl h-12 px-8 text-xs font-bold gap-2 shadow-xl shadow-brand-dark/10">
                  Join Video Session
          ...
          {status === "completed" && (
            <>
              <Button variant="outline" className="rounded-xl h-12 px-6 text-xs font-bold gap-2 border-brand-light/20">
