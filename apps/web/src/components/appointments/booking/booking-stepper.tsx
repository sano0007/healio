            ...
            <li key={step.id} className="relative z-10 flex flex-col items-center group">
              <div
                className={cn(
                  ...
                  isCompleted ? "bg-brand-dark border-brand-dark" : 
                  isActive ? "bg-white border-brand-dark shadow-lg shadow-brand-dark/20" : 
              ...
              <div className="absolute top-12 flex flex-col items-center min-w-[120px] text-center">
                <span className={cn(
                  ...
                  isActive || isCompleted ? "text-brand-dark" : "text-gray-400"
                )}>
                  {step.name}
                </span>
              </div>
