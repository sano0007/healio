            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-sm font-bold text-brand-black">
                  {data.target === 'self' ? 'John Doe (You)' : 'Family Member'}
                </div>
              </div>
            </div>
            {data.reason && (
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm font-medium text-brand-black leading-relaxed line-clamp-2 italic">
                    "{data.reason}"
                  </div>
                </div>
              </div>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <button
            ...
            className={cn(
              ...
              method === 'card'
                ? 'bg-white border-brand-dark shadow-lg shadow-brand-dark/10'
